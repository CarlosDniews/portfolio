...
const en: Translations = {
  ...
  about: {
    label: 'About',
    headingPrefix: 'Who am ',
    headingGradient: 'I',
    headingSuffix: '?',
    bio: "I'm a Software Engineer and Tech Lead with over 7 years of experience in software development. Proven track record in architecting scalable solutions for Web Development, FinTech, ERP and Business Intelligence sectors. Expert in modernizing legacy systems and leading technical teams through the transition to modern stacks (NextJS, NestJS, TypeScript). Currently focused on web development, AI integration, automations and Cloud architectures.",
...
const pt: Translations = {
  ...
  about: {
    label: 'Sobre',
    headingPrefix: 'Quem sou ',
    headingGradient: 'eu',
    headingSuffix: '?',
    bio: 'Sou Engenheiro de Software e Tech Lead, com mais de 7 anos de experi\u00eancia em desenvolvimento de software. Hist\u00f3rico comprovado em arquitetar solu\u00e7\u00f5es escal\u00e1veis para os setores de Desenvolvimento Web, FinTechs, ERP e Business Intelligence. Especialista em modernizar sistemas legados e liderar equipes t\u00e9cnicas na transi\u00e7\u00e3o para stacks modernas (NextJS, NestJS, TypeScript). Atualmente focado em desenvolvimento Web, integra\u00e7\u00e3o de IA, automa\u00e7\u00f5es e arquiteturas Cloud.',
    ...
    items: [
      {
        ...
        highlights: [
          ...
          'Constru\u00ed toda a infraestrutura Cloud e cultura DevOps do zero \u2014 pipelines CI/CD no GitHub, testes automatizados, monitoramento de performance.',
          'Desenvolvi uma solu\u00e7\u00e3o de BI com IA rastreando 30+ KPIs com um Chatbot de IA integrado que consulta o banco de dados diretamente.',
          'Desenvolvi uma plataforma cloud unificada com IA para gest\u00e3o de produtos dos clientes (fotos, metadados, cat\u00e1logo).',
          'Constru\u00ed uma plataforma gratuita de NFS-e (Nota Fiscal de Servi\u00e7o Eletr\u00f4nica) integrada \u00e0 API do Governo Brasileiro.',
      ...
      },
      {
        ...
        highlights: [
          'Desenvolvi solu\u00e7\u00f5es de trading de alta frequ\u00eancia para o "Profit", plataforma l\u00edder de FinTech/InvestTech usada por milhares de traders no Brasil.',
          'Trabalhei extensivamente com Delphi em aplica\u00e7\u00f5es desktop de trading exigindo lat\u00eancia sub-milissegundo.',
          'Liderei otimiza\u00e7\u00f5es de performance que reduziram significativamente a lat\u00eancia de renderiza\u00e7\u00e3o e processamento de dados.',
          'Membro-chave da equipe de sustenta\u00e7\u00e3o, resolvendo d\u00e9bitos t\u00e9cnicos complexos, bugs estruturais e condi\u00e7\u00f5es de corrida.',
          'Colaborei com equipes de produto e QA para entregar releases est\u00e1veis e prontas para produ\u00e7\u00e3o a um p\u00fablico financeiro cr\u00edtico.',
        ],
      },
      {
        company: 'DASS',
        ...
        period: 'Jun 2023 \u2013 Jun 2024',
        highlights: [
          'Constru\u00ed e mantive aplica\u00e7\u00f5es web B2B/B2C usando Vue.js, Node.js e PL/SQL para fluxos de supply-chain e e-commerce.',
          'Projetei e implementei uma Biblioteca de Componentes UI customizada que padronizou a identidade visual e aumentou a produtividade da equipe.',
          'Otimizei fluxos de UX e responsividade das telas, reduzindo o tempo de conclus\u00e3o de tarefas do usu\u00e1rio.',
          'Participei ativamente de cerim\u00f4nias Scrum; liderei demos de sprint e contribu\u00ed para o refinamento do backlog.',
          'Integrei microsservi\u00e7os RESTful conectando interfaces front-end com sistemas back-end baseados em Oracle.',
        ],
      },
      {
        company: 'SAP',
        ...
        highlights: [
          'Trabalhei em m\u00f3dulos core do SAP ERP \u2014 eDocument e Sales & Distribution (SD) \u2014 usando ABAP e Fiori.',
          'Resolvi problemas estruturais complexos em uma base de c\u00f3digo de larga escala atendendo milhares de clientes globais.',
          'Colaborei com equipes intercontinentais (Alemanha, \u00cdndia, EUA) garantindo conformidade com regulamenta\u00e7\u00f5es fiscais de m\u00faltiplos pa\u00edses.',
          'Entreguei patches cr\u00edticos e melhorias de funcionalidade dentro de janelas SLA apertadas para clientes enterprise.',
          'Adquiri profunda expertise em automa\u00e7\u00e3o de processos de neg\u00f3cio, compliance fiscal e padr\u00f5es de faturamento eletr\u00f4nico.',
        ],
      },
      {
        company: 'WEDY',
        ...
        highlights: [
          'Desenvolvi aplica\u00e7\u00f5es web responsivas usando Vue.js e Ruby on Rails para uma startup de marketplace de casamentos.',
          'Contribu\u00ed para o design e implementa\u00e7\u00e3o de novos recursos para a plataforma principal do marketplace.',
          'Participei de sess\u00f5es de teste com usu\u00e1rios e traduzi feedback de UX em melhorias acion\u00e1veis no front-end.',
          'Colaborei estreitamente com designers para implementar interfaces pixel-perfect com abordagem mobile-first.',
        ],
      },
    ],
  },
...
const es: Translations = {
  ...
  about: {
    label: 'Sobre m\u00ed',
    headingPrefix: '\u00bfQui\u00e9n soy ',
    headingGradient: 'yo',
    headingSuffix: '?',
    bio: 'Soy Ingeniero de Software y Tech Lead con m\u00e1s de 7 a\u00f1os de experiencia en desarrollo de software. Historial comprobado en arquitectar soluciones escalables para los sectores de Desarrollo Web, FinTechs, ERP y Business Intelligence. Especialista en modernizar sistemas legados y liderar equipos t\u00e9cnicos en la transici\u00f3n a stacks modernas (NextJS, NestJS, TypeScript). Actualmente enfocado en desarrollo Web, integraci\u00f3n de IA, automatizaciones y arquitecturas Cloud.',
    ...
    items: [
      {
        ...
        highlights: [
          ...
          'Constru\u00ed toda la infraestructura Cloud y cultura DevOps desde cero \u2014 pipelines CI/CD en GitHub, pruebas automatizadas, monitoreo de rendimiento.',
          'Desarroll\u00e9 una soluci\u00f3n de BI con IA rastreando 30+ KPIs con un Chatbot de IA integrado que consulta la base de datos directamente.',
          'Desarroll\u00e9 una plataforma cloud unificada con IA para gesti\u00f3n de productos de los clientes (fotos, metadatos, cat\u00e1logo).',
          'Constru\u00ed una plataforma gratuita de NFS-e (Factura Electr\u00f3nica de Servicio) integrada con la API del Gobierno Brasile\u00f1o.',
      ...
      },
      {
        ...
        highlights: [
          'Desarroll\u00e9 soluciones de trading de alta frecuencia para "Profit", plataforma l\u00edder de FinTech/InvestTech utilizada por miles de traders en Brasil.',
          'Trabaj\u00e9 extensamente con Delphi en aplicaciones de escritorio de trading que requieren latencia sub-milisegundo.',
          'Lider\u00e9 optimizaciones de rendimiento que redujeron significativamente la latencia de renderizado y procesamiento de datos.',
          ...
          'Colabor\u00e9 con equipos de producto y QA para entregar releases estables y listas para producci\u00f3n a un p\u00fablico financiero cr\u00edtico.',
        ],
      },
      {
        company: 'DASS',
        ...
        period: 'Jun 2023 \u2013 Jun 2024',
        highlights: [
          'Constru\u00ed y mantuve aplicaciones web B2B/B2C usando Vue.js, Node.js y PL/SQL para flujos de supply-chain y e-commerce.',
          'Dise\u00f1\u00e9 e implement\u00e9 una Biblioteca de Componentes UI personalizada que estandariz\u00f3 la identidad visual y aument\u00f3 la productividad del equipo.',
          'Optimic\u00e9 flujos de UX y responsividad de pantallas, reduciendo el tiempo de finalizaci\u00f3n de tareas del usuario.',
          'Particip\u00e9 activamente en ceremonias Scrum; lider\u00e9 demos de sprint y contribu\u00ed al refinamiento del backlog.',
          'Integr\u00e9 microservicios RESTful conectando interfaces front-end con sistemas back-end basados en Oracle.',
        ],
      },
      {
        company: 'SAP',
        ...
        period: 'Feb 2021 \u2013 Feb 2023',
        highlights: [
          'Trabaj\u00e9 en m\u00f3dulos core del SAP ERP \u2014 eDocument y Sales & Distribution (SD) \u2014 usando ABAP y Fiori.',
          'Resolv\u00ed problemas estructurales complejos en una base de c\u00f3digo de gran escala atendiendo a miles de clientes globales.',
          'Colabor\u00e9 con equipos intercontinentales (Alemania, India, EE.UU.) asegurando el cumplimiento de regulaciones fiscales de m\u00faltiples pa\u00edses.',
          'Entregu\u00e9 parches cr\u00edticos y mejoras de funcionalidad dentro de ventanas SLA ajustadas para clientes enterprise.',
          'Adquir\u00ed profunda expertise en automatizaci\u00f3n de procesos de negocio, cumplimiento fiscal y est\u00e1ndares de facturaci\u00f3n electr\u00f3nica.',
        ],
      },
      {
        company: 'WEDY',
        ...
        highlights: [
          'Desarroll\u00e9 aplicaciones web responsivas usando Vue.js y Ruby on Rails para una startup de marketplace de bodas.',
          'Contribu\u00ed al dise\u00f1o e implementaci\u00f3n de nuevas funcionalidades para la plataforma principal del marketplace.',
          'Particip\u00e9 en sesiones de prueba con usuarios y traduje feedback de UX en mejoras accionables en el front-end.',
          'Colabor\u00e9 estrechamente con dise\u00f1adores para implementar interfaces pixel-perfect con enfoque mobile-first.',
        ],
      },
    ],
  },
